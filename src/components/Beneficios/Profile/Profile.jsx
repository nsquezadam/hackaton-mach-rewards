  ...
  return (
    <div className="profile">
          ...
          <div className="containerIconInfo">
            ...
            >
              <div className="indicator">
                <p className="pointsProgressBar">
                  {" "}
                  <img src={logoColores} alt="" /> {data[user].puntos}{" "}
                </p>
                <p>Puntos</p>
              </div>
            </ProgressBar>
      ...
      <button
        ...
        onClick={() => setModalHistory(!modalHistory)}
      >
